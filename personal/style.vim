...
"----------------------------------------------------------------------
aug cursorlinetoggle
  autocmd!
autocmd WinEnter * set cursorline               " enter window highlight
autocmd WinLeave * set nocursorline             " leave window cancel
autocmd InsertEnter * set nocursorline          " insert mode cancel highlight
autocmd InsertLeave * set cursorline            " leave insert recover highlight
aug END


"----------------------------------------------------------------------
" set somen keyword to highlight
"----------------------------------------------------------------------
aug highlight_keywords
    autocmd!
    autocmd Syntax * call matchadd('Todo', '\W\zs\(CHANGED\|DONE\|HACK\)')
    autocmd Syntax * call matchadd('Debug', '\W\zs\(NOTE\|INFO\|IDEA\|NOTICE\|BUG\)')
aug END
...
set statusline+=\ [%1*%M%*%n%R%H]               " buffer num and status
